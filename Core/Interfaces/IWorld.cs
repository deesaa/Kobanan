...
namespace Kobanan
{
    public interface IWorld
    {
        ...
        void Update();
        void Destroy();
        void OnComponentCreated(IEntity entity, IComponentBase component, BigInteger typeId);
        void OnComponentDeleted(IEntity entity, IComponentBase component, BigInteger typeId);
